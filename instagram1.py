...
|___/|_|  |_|___/_| |___| {H}Bruteforce version 1.00 by cyberdemon404 {N}'''

def LoginCookie():
    print(Banner())
    print(f'\n{N}[{H}!{N}] Login fresh cookie ')
...
[%s0%s] Keluar\n'''%(N,H,N,H,N,H,N,H,N,H,N,H,N,H,N,M,N))
    ...
    if main in   ['1','01']:
       ...
       os.system(f'xdg-open https://wa.me/+2348178406817?text={text}')
    elif main in ['0','00']:
...
def UserAgent():
    ...
    ua1 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; INFINIX MOBILITY LIMITED/Infinix; Infinix X657B; Infinix-X657B; mt6761; en_GB; {kode})'
